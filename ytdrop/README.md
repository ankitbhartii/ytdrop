...
1. **Paste** a YouTube URL in the input
2. Choose **MP3** (audio, ~320kbps VBR) or **MP4** (up to 1080p)
3. Hit **Convert & Download** — the server runs `yt-dlp` and streams the file back
4. Files are **deleted automatically** after download (or after 1 hour)
